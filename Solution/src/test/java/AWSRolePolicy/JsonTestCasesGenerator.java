...
public class JsonTestCasesGenerator {
    public static List<String> generateValidTestCases(){
        ...
        testCases.add("{\"PolicyName\":\"TestPolicy\",\"PolicyDocument\":{\"Version\":\"2012-10-17\",\"Statement\":[{\"Action\":\"s3:GetObject\",\"Effect\":\"Allow\",\"Resource\":\"*\"}]}}");
        testCases.add("{\"PolicyName\":\"TestPolicy2\",\"PolicyDocument\":{\"Version\":\"2012-10-17\",\"Statement\":[{\"Action\":\"s3:GetObject\",\"Effect\":\"Allow\",\"Resource\":\"FF\"}]}}");
        testCases.add("{\"PolicyName\":\"TestPolicy3\",\"PolicyDocument\":{\"Version\":\"2012-10-17\",\"Statement\":[{\"Action\":\"s3:GetObject\",\"Effect\":\"Allow\",\"Resource\":\"res\"}]}}");
        testCases.add("{\"PolicyName\":\"TestPolicy4\",\"PolicyDocument\":{\"Version\":\"2012-10-17\",\"Statement\":[{\"Action\":\"s3:GetObject\",\"Effect\":\"Allow\",\"Resource\":\"FF\"}]}}");
        testCases.add("{\"PolicyName\":\"TestPolicy5\",\"PolicyDocument\":{\"Version\":\"2012-10-17\",\"Statement\":[{\"Action\":\"s3:GetObject\",\"Effect\":\"Deny\",\"Resource\":\"FF\"}]}}");
        testCases.add("{\"PolicyName\":\"TestPolicy4\",\"PolicyDocument\":{\"Version\":\"2012-10-17\",\"Statement\":[{\"Action\":\"s3:GetObject\",\"Effect\":\"Allow\",\"Resource\":\"*\"}]}}");
        return testCases;
    }
